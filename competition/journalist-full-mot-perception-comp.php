...
// set the stimulus folder (can change this to random assignment later)
    ...
    {stimulus: train_stimuli_array[0], data: {test_part: 'c1_train', correct_response: ',', job: 'journalist'}},//{stimulus: train_stimuli_array[0]}, //{stimulus: train_stimuli_array[0], data: {test_part: 'test', correct_response: ','}},
    {stimulus: train_stimuli_array[30], data: {test_part: 'c1_train', correct_response: ',', job: 'journalist'}},  //{stimulus: train_stimuli_array[1]}, //{stimulus: train_stimuli_array[1], data: {test_part: 'test', correct_response: ','}},
    {stimulus: train_stimuli_array[65], data: {test_part: 'c1_train', correct_response: '.', job: 'journalist'}},  //{stimulus: train_stimuli_array[2]},  //{stimulus: train_stimuli_array[2], data: {test_part: 'test', correct_response: '.'}},
    ]
  ...
  data: jsPsych.data.get().select('responses')
    ...
    var instructions_8 = {
      ...
      stimulus: '<p style="color:white;">Phase I of the experiment is complete.</p> ' +
          '<p style="color:white;">In the second half, you will be performing the same classification task. However, you will also be <strong> competing against</strong> another Turker to earn money. </p> ' +
          '<p style="color:white;">Press the space bar to continue.</p> ',
      choices: [32],
      post_trial_gap: 2000
    };
    ...
    var instructions_11 = {
      type: "html-keyboard-response",
      stimulus: '<p style="color:white;"> Finding your opponent for the HIT... </p> ',
    ...
    var instructions_12 = {
      ...
      'p <div class="card"> <img src="images/avator.png" alt="Avatar" style="width:100%"><div class="container"> <h4><b> Your opponent</b></h4><p> Occupation: Journalist </p> </div></div> </p>',
    ...
    var instructions_13 = {
      ...
      //'p style="color:white;"> Your partner: </p>'+
      'p <div class="card"> <img src="images/avator.png" alt="Avatar" style="width:100%"><div class="container"> <h4><b> Your opponent</b></h4><p> Occupation: Journalist </p> </div></div> </p>'+
      '<p style="color:white;"> Press the space bar when you are ready to start the second half of the HIT. <br> Let us begin! </p> ',
      choices: [32],
    };
...
function saveData(name, data){
  ...
  xhr.open('POST', 'journalist-full-mot-perception-comp.php'); // 'write_data.php' is the path to the php file described above.
...
//var this_seed = new Date().getTime();
    ...
    function startExperiment(){
      jsPsych.init({
        ...
        on_finish: function(){ saveData("journalist-full-mot-perception-comp_" + workerID, jsPsych.data.get().csv()); }
        //on_finish: function(){
