...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // submit button commented out to speed up experiment

    html += '</form>'

    display_element.innerHTML = html;

    display_element.querySelector('#jspsych-survey-likert-form').addEventListener('click', function(e){ //changed from 'submit' to 'click' to speed up
      e.preventDefault();
