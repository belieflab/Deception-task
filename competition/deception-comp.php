...
<html>
  ...
  <div id="consentForm" class="consent consent-box"> 
    ...
    <p id="consentInstructions" class="consent">
      ...
      <br>
      You will receive the reward specified on the Mechanical-Turk HIT for completing both the game and the questionnaire. Payment for completion of the HIT is up to $7 based on task performance. Upon finishing the game and submitting the questionnaire, you will receive code numbers. Please record these two code numbers and submit them for payment. 
      <br><br>
...
var likert_train_page = {
  ...
  data: jsPsych.data.get().select('responses')
    ...
    var instructions_9 = {
      type: "html-keyboard-response",
      stimulus: 
          '<p style="color:white;">You will be asked to choose to accept advice about whether the image is more "Face" or more "Scene" <strong> or </strong> choose to offer advice to an opponent about whether the image is more "Face" or more "Scene". </p> ' +
			    '<p style="color:white;"> Your opponent will be given the same choice. </p> ' +
          '<p style="color:white;">If you agree on the same action, you will be given that information. </p> ' +
          '<p style="color:white;">If you do not agree with your opponent, either you or your opponent will be randomly selected to give advice about the image to the other person. </p> ' +
			    '<p style="color:white;"> <strong> Your goal is to <strong> correctly identify more images than your opponent.</strong></p>'+
...
//choose
  var advice_choose = {
    ...
    stimulus: '<p style="color:white;"> Would you like to accept advice from your opponent or give advice to your opponent? </p>',
 ...
 var give_advice = {
  type: "html-button-response",
  stimulus: '<p style="color:white;"> What would you like to tell your opponent about the image? </p>',
  choices: ['Face', 'Scene'],
  on_finish: function(data){
        data.image = jsPsych.timelineVariable('stimulus');
  }
...
var recieve_advice = {
  type: 'html-keyboard-response',
  timeline: [{
              stimulus: function(){return'<p style="color:white;"> Your opponent tells you the image is a ' +jsPsych.timelineVariable('predict_bet', true)+ '</p>'+
                '<p style="color:white;"> Press the space bar to continue </p>';
  }}],
...
{
    type: 'html-keyboard-response',
    stimulus: function(){return '<p style="color:white;"> You elected to give advice, and your opponent ' +jsPsych.timelineVariable('give_words', true)+'</p>'+
      '<p style="color:white;"> Press the space bar to continue </p>'},
    choices: [' '],
    on_finish: function(data){
...
var advice_outcome_recieve1 = 
{
    type: 'html-keyboard-response',
    choices: [' '],
    stimulus: function(){return '<p style="color:white;"> You elected to recieve advice, and your opponent ' +jsPsych.timelineVariable('recieve_words', true)+'</p>'+
      '<p style="color:white;"> Press the space bar to continue </p>'},
      on_finish: function(data){
...
var advice_outcome_recieve2 = {
    type: 'html-keyboard-response',
    choices: [' '],
    stimulus: function(){return '<p style="color:white;"> You elected to give advice, and your opponent ' +jsPsych.timelineVariable('recieve_words', true)+'</p>'},
...
var if_node1 = {
    ...
    conditional_function: function(data){
       ...
       var advice_choice = jsPsych.data.getLastTrialData().select('advice_choose').values
        if(advice_choice == 0){
          // so this then shows a slide where it says they gave advice+their opponent's response! 
            return true;
        } else {
            return false;
        }
  ...
  var instructions_13 = {
      type: "html-keyboard-response",
      stimulus: '<p style="color:white;"> Remember: your goal is to <strong> correctly identify more images than your opponent.</strong></p> '+
      '<p style="color:white;"> You will recieve a monetary bonus of $2 if you score higher than your opponent. </p> '+
      '<p style="color:white;">Press the space bar when you are ready to start! </p>',
      //'p style="color:white;"> Your opponent: </p>'+
      //'p <div class="card"> <img src="images/avator.png" alt="Avatar" style="width:100%"><div class="container"> <h4><b> Your opponent</b></h4><p> Occuptation: Doctor </p> </div></div> </p>'+
  ...
  var instructions_12 = {
      type: "html-keyboard-response",
      stimulus: '<p style="color:white;"> Finding your opponent for the HIT...let us begin! </p> '+
...
//experimental manipulation? 
 ...
 //           type: "html-keyboard-response",
            //stimulus: //'
 //           stimulus: 
                    //'<p style="color:white;"> Your opponent bet 7 cents that the next image has more </p> ' +
 //                   function(){
...
function saveData(name, data){
  ...
  xhr.open('POST', 'deception-comp.php'); // 'write_data.php' is the path to the php file described above.
...
//var this_seed = new Date().getTime();
    ...
    function startExperiment(){
      jsPsych.init({
        ...
        on_finish: function(){ saveData("deception-comp_" + workerID, jsPsych.data.get().csv()); }
        //on_finish: function(){
